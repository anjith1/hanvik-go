...
const WorkerDetails = ({ workers }) => {
  ...
  const handleConfirm = async (worker) => {
    ...
    try {
      await axios.post(
        `${import.meta.env.VITE_API_URL}/api/orders/direct`,
        {
          workerId: worker._id,
              ...
              <div className="booking-panel">
                {s.success ? (
                  <div className="booking-success">
                    ✅ Scheduling confirmed! The service partner will contact you soon.
                  </div>
                ) : (
                  <>
                    <h4 className="booking-panel-title">Schedule {worker.fullName}</h4>
                    ...
                    <button
                      ...
                      disabled={s.loading}
                    >
                      {s.loading ? 'Scheduling...' : 'Confirm Schedule'}
                    </button>
                  </>
                )}
              </div>
